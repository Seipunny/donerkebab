namespace EasyPeasyFirstPersonController
{
    ...
    public partial class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            bool wantsToCrouch = canCrouch && inputActions.Player.Crouch.IsPressed() && !isSliding;
            ...
            if (canSlide && isSprinting && inputActions.Player.Crouch.WasPressedThisFrame() && isGrounded)
            {
                isSliding = true;
        ...
        private void HandleMovement()
        {
            ...
            moveInput.x = move.x;
            moveInput.y = move.y;
            isSprinting = canSprint && inputActions.Player.Sprint.IsPressed() && moveInput.y > 0.1f && isGrounded && !isCrouching && !isSliding;
